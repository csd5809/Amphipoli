...
public class Controller {
    ...
    private Player thief;       //o eikonikos paikths thief
    ...
    public Controller() {
        ...
        int response = JOptionPane.showOptionDialog(null, "Select Game Mode:", "Amphipolis",JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE,null, options, options[0]);

        if (response == JOptionPane.CLOSED_OPTION) {
            System.exit(0); // Τερματίζει το πρόγραμμα αμέσως
        }
    ...
    public void endTurn(boolean force) {
        ...
        */
        ...
        if (isSoloMode) {
            currentPlayerIndex = 0; //menei panta o idios paikths
    ...
    private void handleThiefTurn() {
        ...
        for(Tile t : board.getMosaicArea()) view.removeTileFromBoard(t, 0); // update view 
        board.getMosaicArea().clear(); // clear apo to model
